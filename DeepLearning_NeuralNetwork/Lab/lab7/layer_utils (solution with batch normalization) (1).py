...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
  """Convenience layer that performs an affine transform followed by bacth normalization and ReLU.
  """
  a, fc_cache = affine_forward(x, w, b)
...
def affine_batchnorm_relu_backward(dout, cache):
  """Backward pass for affine-batch-normalization-relu convenience layer 
  """
